...
class account_loan_integration(models.Model):
    ...
    estado_loan = fields.One2many(comodel_name="account.loan.estadostp", string="State STP", inverse_name="accountloan_id")
    claveRastreo = fields.Char(string="Clave Rastreo")
    loan_id = fields.Char(string="Loand Id Clip")
    loan_id_stp = fields.Char(string="Id STP", compute="get_idstp")
    ref_numerica = fields.Integer(string="Number Reference ")
    conceptoPago = fields.Char(string="Payment concept")
    resut_stp_json = fields.Text(string="STP Result")
    resut_clip_json = fields.Text(string="CLIP Result")
    fecha_dipersion = fields.Datetime(string="Dispersion Date")
    fecha_contrato = fields.Datetime(string="Contract Date")
    fecha_venciminto = fields.Date(string="Expiration date")
    cuentaOrdenante = fields.Char(string="Dispersion Account")
    id_prestamo =fields.Char(string="Credit ID", store = True)
    pay_periodo = fields.Monetary(string="Payment period", compute="get_pagos", store = True)

    comision = fields.Monetary(string="Commission")

    pay_back = fields.Monetary(string="PayBack")
    total_interes = fields.Monetary(string="Total Interest")
    tasa = fields.Float(string="Rate (annualized)", compute="get_pagos", store = True)
    comision = fields.Float(string="% Commission")
    tir = fields.Float(string="Estimated IRR")
    tir_actual = fields.Float(string="Actual IRR")
    tir_proyect = fields.Float(string="Projected IRR")

    merchan = fields.Char(string="Id Client")
    merchan_id = fields.Char(string="Proxy Merchant Token")
    cuenta_clabe_stp = fields.Char(string="Key account")
    iva = fields.Monetary(string="VAT")

    retencion = fields.Float(string="Retention %")
    clasif_seg = fields.Char(string="Followup Classification")
    coef_seg = fields.Char(string="Followup ratio")
    plazo_tranc = fields.Float(string="Term %")
    por_cobranza = fields.Float(string="Collection %")
    count_dias_ult_pago = fields.Integer(string="Days Without Payment")
    date_lastpay = fields.Date(string="Last Payment Date")
    days_before_pay = fields.Integer(string="Days untill Due Date")
    tasa_mora = fields.Integer(string="Moratory Interest Rate")

    total_pay = fields.Monetary(string="Collected Principal")
    interes_pay = fields.Monetary(string="Collected Interests")
    iva_pay = fields.Monetary(string="Collected VAT")
