...
class AccountLoan(models.Model):
    ...
    @api.model
    def _get_default__company_id(self):
    ...
    type_periods = fields.Selection([('mes', 'Mensual'), ('quincena', 'Quincenal'), ('semana', 'Semanal')
                                    ], string="Tipo de periodo", default="mes", required=True )
    ...
    rate_type = fields.Selection(
        [("napr", "Nominal APR"), ("ear", "EAR"), ("real", "Real rate"),("periodo", "Por Periodo")],
        required=True,
    ...
    @api.model
    def compute_rate(self, rate, rate_type, method_period, periods):
        """
    ...
    def loan_rate(self):
        return self.compute_rate(self.rate, self.rate_type, self.method_period, self.periods)
